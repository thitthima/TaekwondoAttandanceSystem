...
<center><table id="student">
	...
	<br>
	<center><a href="studentRegisterAdminEdit.php"><button class='button1' type='submit'>Add Student</button></a></center>
		<br>
	<a href="search.php"><button class="button1" onclick="goBack()">Search Student</button>
	<br><br>
