...
?>
		...
		<form action="studentRegisterEditSubmit.php" method="post" style="text-align:left;">
		...
		<center><a href="studentRecord.php"><button class="button2" onclick="goBack()">Back</button></center>
