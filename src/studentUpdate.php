...
<table>
	...
	<?php
	 ...
	 {
		 echo "<tr><form action='studentUpdateSubmit.php' method=post>";

		echo "<td><input type=text name=studentID value='".$row['studentID']."'</td>";
		 echo "<td><input type=text name=password value='".$row['password']."'</td>";
		 echo "<td><input type=text name=name value='".$row['name']."'</td>";
		 echo "<td><input type=text name=matricNo value='".$row['matricNo']."'</td>";
